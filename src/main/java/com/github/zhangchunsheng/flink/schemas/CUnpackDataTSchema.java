 ...
 */
public class CUnpackDataTSchema implements DeserializationSchema<Tuple2>, SerializationSchema<Tuple2<String, CUnpackDataT>> {
    ...
    @Override
    public boolean isEndOfStream(Tuple2 cUnpackDataT) {
        return false;
    }

    @Override
    public byte[] serialize(Tuple2<String, CUnpackDataT> value) {
